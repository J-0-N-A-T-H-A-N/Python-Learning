...
def show_post(index):
    # .get() works on single primary key value - in this case the record id
...
<<<<<<< HEAD
=======
>>>>>>> 2b42e8f75d90642a1804bf9cfdf968881ed60035
...
def edit_post(post_id):
    ...
    return render_template("make-post.html", form=form, action="edit", post=post_to_edit)
